            		...
            		<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
                  	<h2><a title="<?php the_title_attribute(); ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
              			<?php if ( has_post_thumbnail()) : ?>
              				<p>
              				<?php the_post_thumbnail('blog-thumb', array('class' => ' border')); ?>
              				</p>
              			<?php endif; ?>
              			<?php the_excerpt(); ?>
                     <img src="<?php echo get_template_directory_uri(); ?>/images/blog-banner.png" width="60" class="banner" alt="banner" />
            		</div> <!-- end .post -->
                  <div class="right">
                  	<div class="date">

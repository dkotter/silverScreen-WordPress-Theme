<?php
/*
Template Name: Theater3 Page Template
*/
?>
<?php 
         ...
         <div id="container">
         	<div class="info radius border">
            	<?php
					...
					if ($dkk_settings['theater3'] == urldecode($theater)) {
               ...
               3D Prices are based on regular admission plus $2.00. Coupons are only valid for the regular admission portion unless specified otherwise.
					<?php } ?>
               <?php if($dkk_settings['theater3'] == urldecode($theater) && !$comments && $threeD != '3D') {
               ...
               endwhile;
					echo '<h1>No movies playing at this theater</h1>'; 
					endif; ?>
            </div>
         	<div class="info radius border">
            	<h1>LOCATION</h1>
               <?php if($dkk_settings['map_url3']) { ?>
               <div class="lft_col">
                  <img src="<?php echo $dkk_settings['map_url3']; ?>" class="map" alt="Map to the <?php echo $dkk_settings['theater3'] ?>" />
               </div> <!-- end .map -->
               <?php } ?>
               <?php if($dkk_settings['location3']) { ?>
               <div class="rt_col location">
                  <p>
                  	<?php echo $dkk_settings['location3']; ?>
                  </p>
               </div>
               <?php } ?>
               <div class="clear"></div>
